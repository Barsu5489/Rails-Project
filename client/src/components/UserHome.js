...
function UserHome() {
  ...
  return (
    ...
    {userInfo ? (<h1> <span style={{color:'Green'}}>{userInfo}</span>, <br />the Portfolio Picaso</h1>):(<><h1>Be captain of <br /> the Portfolio Ship <span className='access' onClick={()=>redirect('/login')}>Get a Job</span></h1> 
